...
/*VARIAVEIS*/
var droneDX{DRONE, T}, >=0, <= dimSquare, integer;
var droneDY{DRONE, T}, >=0, <= dimSquare, integer;
...
calcDronesAVGSpeed: dronesMaxSpeed >= sum{d in DRONE} sum{t in T:t>=2} droneSpeed[d,t] ;
